...
- Return `Some(ge)` even if the x-coordinate is not normalized."#,
        ...
        Elements::GejGeAddEx => "Add two points. Also return the ratio of the result's z-coordinate to `a`'s z-coordinate. If the result is the point at infinity, it is returned in canonical form.",
