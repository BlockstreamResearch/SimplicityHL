...
# Bitcoin still uses older hash/hex crates than Elements and Simplicity.
# derive_arbitrary, wasm tooling and serde use different syn majors.
allowed_duplicates = ["bitcoin_hashes", "hex-conservative", "syn"]
